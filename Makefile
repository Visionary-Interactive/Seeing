...
Seeing: raylib
ifneq (,$(Seeing_config))
	@echo "==== Building Seeing ($(Seeing_config)) ===="
	@${MAKE} --no-print-directory -C build/build_files -f Seeing.make config=$(Seeing_config)
endif
...
clean:
	@${MAKE} --no-print-directory -C build/build_files -f Seeing.make clean
